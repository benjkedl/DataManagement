...
class LearningModule {
    constructor() {
        ...
        this.slideData = {
            ...
            dataTypeQuiz: [
                {question: "\"Hello World\"", correct: "string", explanation: "Text enclosed in quotes is a string data type"},
                {question: "42", correct: "integer", explanation: "Whole numbers are integer data types"},
                ...
                {question: "2024-07-01", correct: "datetime", explanation: "Date representations are datetime data types"},
                {question: "false", correct: "boolean", explanation: "True/false values are boolean data types"},
                {question: "-17", correct: "integer", explanation: "Negative whole numbers are still integer data types"},
                {question: "0.5", correct: "float", explanation: "Decimal numbers are float data types"},
